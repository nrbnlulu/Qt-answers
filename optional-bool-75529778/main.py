...
class Foo(QObject):
    ...
    def __init__(self):
        super().__init__(None)
        self._triple_bool: tuple[bool | None, bool | None, bool | None] = (
            None,
            None,
            None,
        )
    ...
    def set_triple_bool(
        self, a: bool | None = None, b: bool | None = None, c: bool | None = None
    ):
...
class Main(QMainWindow):
    def __init__(self):
        ...
        btn.clicked.connect(
            lambda: self.foo_alternative.emit_triple_bool(True, False, None)
        )
