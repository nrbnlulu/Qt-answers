from PyQt5.QtWidgets import QMainWindow, QApplication, QPushButton, QFileDialog, QFrame, QGridLayout, QLineEdit
...
class Main(QMainWindow):
    def __init__(self):
        ...
        for i in range (10):
            ...
            btn.clicked.connect(lambda: self.open_dialog(le))
